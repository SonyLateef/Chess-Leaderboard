/**
 * This code has been provided for you The only modifications you need to make are deleting the
 * comments, and removing the filler code, like return null or System.out.println("Unsupported
 * Operation") as you complete the AVLPlayerNode class. Aside from getTree, all commented code is
 * inside of the driverLoop
 * This is the ScoreKeeper class that simulates the output for the program.
 * Known bugs: None
 *
...
public class ScoreKeeper {
	...
	public static void driverLoop(Scanner scan, AVLPlayerNode eloTree, AVLPlayerNode idTree,
			int numPeople) {
			...
			switch (ans) {
				...
				case 'D':
					if (numPeople > 3) {
						...
						System.out.println(
								"Please enter the ID number of the player you wish to remove from the system");
						int id = scan.nextInt();
				...
				case 'M':
					...
					System.out
							.println("Please enter the ID number of the first player in the match");
